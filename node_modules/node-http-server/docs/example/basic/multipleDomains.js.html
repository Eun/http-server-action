...
<div class="subHeading">
    ./example/basic/multipleDomains.js
</div>
...
<code>const server=require(‘node-http-server’);</code></p>
        ...
        <li id="section-2">
            <div class="annotation">
                <p>set up a config with multiple domains on just http</p>
