...
<div class="subHeading">
    ./example/basic/https-advancedApp.js
</div>
...
<code>const server=require(‘node-http-server’);</code></p>
        ...
        <li id="section-2">
            <div class="annotation">
                <p> instantiate <code>config</code> as a new <code>server.config</code> instance so we get all the defaults.
 This will allow us to perform deeper modifications without corrupting the default set.</p>

            </div><div class="content">
                <div class="highlight"><pre><span class="hljs-keyword">const</span> config=<span class="hljs-keyword">new</span> server.Config;</pre></div>
            </div>
        </li>
        ...
        <li id="section-3">
            <div class="annotation">
                <p>inspect the config</p>

            </div><div class="content">
                <div class="highlight"><pre><span class="hljs-built_in">console</span>.log(config);</pre></div>
            </div>
        </li>
        ...
        <li id="section-4">
            <div class="annotation">
                <p>customize the 404 error body</p>

            </div><div class="content">
                <div class="highlight"><pre>config.errors[<span class="hljs-string">'404'</span>]    = <span class="hljs-string">'These are not the files you are looking for...'</span>;</pre></div>
            </div>
        </li>
        ...
        <li id="section-5">
            <div class="annotation">
                <p>add support for mp4</p>

            </div><div class="content">
                <div class="highlight"><pre>config.contentType.mp4  = <span class="hljs-string">'video/mp4'</span>;</pre></div>
            </div>
        </li>
        ...
        <li id="section-6">
            <div class="annotation">
                <p>set the node server port to 8005</p>

            </div><div class="content">
                <div class="highlight"><pre>config.port             = <span class="hljs-number">8005</span>;</pre></div>
            </div>
        </li>
        ...
        <li id="section-7">
            <div class="annotation">
                <p>set the server to be verbose so we can see detailed info on the server, it’s requests and responses</p>

            </div><div class="content">
                <div class="highlight"><pre>config.verbose          = <span class="hljs-literal">true</span>;</pre></div>
            </div>
        </li>
        ...
        <li id="section-8">
            <div class="annotation">
                <p>set the root public directory</p>

            </div><div class="content">
                <div class="highlight"><pre>config.root             = __dirname+<span class="hljs-string">'/appRoot/'</span>;</pre></div>
            </div>
        </li>
        ...
        <li id="section-9">
            <div class="annotation">
                <p>set the node ssl privte key</p>

            </div><div class="content">
                <div class="highlight"><pre>config.https.privateKey = <span class="hljs-string">`<span class="hljs-subst">${__dirname}</span>/../../local-certs/private/server.key`</span>;</pre></div>
            </div>
        </li>
        ...
        <li id="section-10">
            <div class="annotation">
                <p>set the node ssl cert</p>

            </div><div class="content">
                <div class="highlight"><pre>config.https.certificate= <span class="hljs-string">`<span class="hljs-subst">${__dirname}</span>/../../local-certs/server.pub`</span>;</pre></div>
            </div>
        </li>
        ...
        <li id="section-11">
            <div class="annotation">
                <p>set the node ssl port</p>

            </div><div class="content">
                <div class="highlight"><pre>config.https.port       = <span class="hljs-number">4433</span>;</pre></div>
            </div>
        </li>
        ...
        <li id="section-13">
            <div class="annotation">
                <p>take a look at the server instance</p>
