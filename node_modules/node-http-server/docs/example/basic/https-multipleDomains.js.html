...
<html>
<head>
    <title>https-multipleDomains</title>
...
<code>const server=require(‘node-http-server’);</code></p>
        ...
        <li id="section-2">
            <div class="annotation">
                <p>set up a config with multiple domains over ssl</p>
    ...
    <span class="hljs-attr">domains</span>:{
        <span class="hljs-string">'a.myapp'</span>:__dirname+<span class="hljs-string">'/appSubDomainRoot/'</span>,
        <span class="hljs-string">'yourapp.com'</span>:__dirname+<span class="hljs-string">'/appOtherDomainRoot/'</span>
    },
    <span class="hljs-attr">https</span>:{
        <span class="hljs-attr">privateKey</span>:<span class="hljs-string">`<span class="hljs-subst">${__dirname}</span>/../../local-certs/private/server.key`</span>,
        <span class="hljs-attr">certificate</span>:<span class="hljs-string">`<span class="hljs-subst">${__dirname}</span>/../../local-certs/server.pub`</span>,
        ...
        <li id="section-3">
            <div class="annotation">
                <p>checkout the multi domain server instance</p>

            </div><div class="content">
                <div class="highlight"><pre><span class="hljs-built_in">console</span>.log(server);</pre></div>
            </div>
        </li>
        ...
        <li id="section-4">
            <div class="annotation">
                ...
                <div class="highlight"><pre>server.deploy(config);</pre></div>
            </div>
        </li>
