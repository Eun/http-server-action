...
<html>
<head>
    <title>https-basicLogging</title>
...
<div class="subHeading">
    ./example/basic/https-basicLogging.js
</div>
...
<code>const server=require(‘node-http-server’);</code></p>
                ...
                <div class="highlight"><pre>server.deploy(
    {
        ...
        <span class="hljs-attr">log</span>:<span class="hljs-string">'/tmp/server-test-myApp-8000-request.log'</span>,
        ...
        <li id="section-3">
            <div class="annotation">
                <p>checkout the server instance</p>
