...
<div class="subHeading">
    ./example/basic/cluster-basicApp.js
</div>
...
<code>const server=require(‘node-http-server’);</code></p>
        ...
        <li id="section-2">
            <div class="annotation">
                ...
                <div class="highlight"><pre><span class="hljs-keyword">const</span> cluster = <span class="hljs-built_in">require</span>(<span class="hljs-string">'cluster'</span>);
...
<span class="hljs-keyword">if</span> (cluster.isMaster) {
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">`Master <span class="hljs-subst">${process.pid}</span> is running`</span>);</pre></div>
            </div>
        </li>
        ...
        <li id="section-3">
            <div class="annotation">
                <p> Fork node-http-server cluster workers.</p>

            </div><div class="content">
                <div class="highlight"><pre>  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>; i &lt; numCPUs; i++) {
    cluster.fork();
  }
  ...
  server.afterServe=<span class="hljs-function">(<span class="hljs-params">request</span>)=&gt;</span>{
    <span class="hljs-built_in">console</span>.log(<span class="hljs-string">`<span class="hljs-subst">${process.pid}</span> served <span class="hljs-subst">${request.uri.path}</span>`</span>);
        ...
        <li id="section-4">
            <div class="annotation">
                <p>start server in clustered children</p>

            </div><div class="content">
                <div class="highlight"><pre>  server.deploy(
      {
