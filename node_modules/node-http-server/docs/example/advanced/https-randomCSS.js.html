...
<div class="subHeading">
    ./example/advanced/https-randomCSS.js
</div>
    ...
    <ul class="sectionDetails ">
        ...
        <li id="section-1">
            <div class="annotation">
                ...
                <div class="highlight"><pre><span class="hljs-keyword">var</span> os = <span class="hljs-built_in">require</span>( <span class="hljs-string">'os'</span> );</pre></div>
            </div>
        </li>
...
<span class="hljs-keyword">var</span> config=<span class="hljs-keyword">new</span> server.Config;
...
config.server.index=<span class="hljs-string">'randomCSS.html'</span>;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">beforeServe</span>(<span class="hljs-params">request,response,body,encoding</span>)</span>{</pre></div>
        ...
        <li id="section-3">
            <div class="annotation">
                <p>only parse css files</p>

            </div><div class="content">
                <div class="highlight"><pre>    <span class="hljs-keyword">if</span>(response.getHeader(<span class="hljs-string">'Content-Type'</span>)!=server.config.contentType.css){
        <span class="hljs-keyword">return</span>;
    }

    <span class="hljs-keyword">var</span> values={
        <span class="hljs-attr">bgr</span>:getRand(),
        <span class="hljs-attr">bgg</span>:getRand(),
        <span class="hljs-attr">bgb</span>:getRand(),
        <span class="hljs-attr">tr</span>:getRand(),
        <span class="hljs-attr">tg</span>:getRand(),
        <span class="hljs-attr">tb</span>:getRand(),
    }

    <span class="hljs-keyword">var</span> vars=<span class="hljs-built_in">Object</span>.keys(values);

    <span class="hljs-keyword">for</span>(<span class="hljs-keyword">var</span> i <span class="hljs-keyword">in</span> vars){
        <span class="hljs-keyword">var</span> reg=<span class="hljs-keyword">new</span> <span class="hljs-built_in">RegExp</span>(
            <span class="hljs-string">'\{\{'</span>+vars[i]+<span class="hljs-string">'\}\}'</span>,
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getRand</span>(<span class="hljs-params"></span>)</span>{
