...
config.root=__dirname+<span class="hljs-string">'/appRoot/'</span>;</pre></div>
        ...
        <li id="section-4">
            <div class="annotation">
                ...
                <div class="highlight"><pre>server.beforeServe=beforeServe;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">beforeServe</span>(<span class="hljs-params">request,response,body,encoding</span>)</span>{</pre></div>
    ...
    <span class="hljs-keyword">var</span> interfaceKeys=<span class="hljs-built_in">Object</span>.keys(networkInterfaces);</pre></div>
            </div>
        </li>
        ...
        <li id="section-7">
            <div class="annotation">
                <p>generate list items with the network interfaces</p>

            </div><div class="content">
                <div class="highlight"><pre>    <span class="hljs-keyword">for</span>(<span class="hljs-keyword">var</span> i <span class="hljs-keyword">in</span> interfaceKeys){
        ...
        <li id="section-8">
            <div class="annotation">
                <p>replace the {{some-content}} var in the body with the list created above</p>
