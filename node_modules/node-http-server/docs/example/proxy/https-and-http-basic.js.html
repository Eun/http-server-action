...
<html>
<head>
    <title>https-and-http-basic</title>
...
this is just an example</p>
                ...
                <div class="highlight"><pre>process.env.NODE_TLS_REJECT_UNAUTHORIZED = <span class="hljs-string">"0"</span>;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">gotRequest</span>(<span class="hljs-params">request,response,serve</span>)</span>{</pre></div>
        ...
        <li id="section-5">
            <div class="annotation">
                ...
                <div class="highlight"><pre>    <span class="hljs-built_in">console</span>.log(request.uri,request.headers);
