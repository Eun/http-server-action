    ...
    <ul class="sectionDetails codeOnly">
        ...
        <li id="section-1">
            <div class="annotation">
                ...
                <div class="highlight"><pre><span class="hljs-meta">#! /usr/bin/env node</span>
